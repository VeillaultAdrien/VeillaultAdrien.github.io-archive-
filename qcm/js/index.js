$('#quiz').quiz({
  ...
  questions: [
    ...
    {
      'q': ' <b>?</b>Quel(s) critère(s) permettent d’évaluer l’amélioration de l’exécution d’une tâche récemment apprise ?',
      'options': [
        'Le temps d’exécution et de nombre d’erreurs',
    ...
    {
      'q': '<b>?</b>A quelle composante de l’utilisabilité l’apprenabilité est-elle le plus liée ?',
      'options': [
        'L\’efficience',
        'L\’efficacité',
		'La satisfaction'
    ...
    {
      'q': '<b>?</b>Quelle est la composante de l’utilisabilité principalement impliquée ici ? <br/><img src="https://i.ibb.co/7R3dH0g/onejob.png">',
      'options': [
        'L\’efficacité',
        'L\’efficience',
        'La satisfaction',
	...
	{
      'q': '<b>?</b>Dans quelle type de situation l’apprenabilité d’un dispositif est-elle la plus importante ?',
      'options': [
	...
	{
      'q': '<b>?</b>Un dispositif efficace est en général également efficient.',
      'options': [
        'Vrai',
        'Faux'
      ],
	...
	{
      'q': '<b>?</b>Un dispositif efficient et facile à apprendre est forcément efficace.',
      'options': [
        'Vrai',
        'Faux'
      ],
	...
	{
      'q': '<b>?</b>Quelles composantes de l’utilisabilité sont impliquées ici ?<br/> <img src="https://i.ibb.co/FxGs2C0/glasses.png">',
      'options': [
        'L\’efficience',
        'L\’efficacité',
		'La satisfaction',
	...
	{
      'q': ' <b>?</b>Dans la vie de tous les jours, la performance acceptable d’un produit est facilement objectivable :',
      'options': [
        'Vrai',
        'Faux'
      ],
